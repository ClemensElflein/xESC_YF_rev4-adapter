...
void UpdateStatus() {
    ...
    MODM_LOG_DEBUG << " VRef=" << AdcSampler::getInternalVref_u() << "mV, "
        ...
        << " CurrentSense=" << AdcSampler::getVoltage(AdcSampler::Sensors::CurSense)
        << "V, "
...
int main() {
    ...
    // to avoid touching unknown GPIOs that might control motors or dangerous hardware!
    ...
    Timer1::configureInputChannel<motor::SATimChan>(
        ...
        Timer1::InputCapturePrescaler::Div1,  // Must match SA_TIMER_INPUT_PRESCALER
